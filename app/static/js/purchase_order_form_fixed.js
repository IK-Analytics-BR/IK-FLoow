document.addEventListener('DOMContentLoaded', function() {
    console.log('Inicializando formulário de pedido de compra...');
    ...
    function loadSupplierData(supplierId) {
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                alert('Erro ao carregar dados do fornecedor. Por favor, tente novamente.');
            }
        });
    }
    ...
    $('#addItem').on('click', function() {
        ...
        try {
            ...
            const newSelect = tbody.find('tr').last().find('.product-select');
            newSelect.select2({
                theme: 'bootstrap-5',
                placeholder: 'Selecione um produto'
            });
