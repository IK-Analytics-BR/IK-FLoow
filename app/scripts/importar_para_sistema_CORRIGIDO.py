"""
Script CORRIGIDO para importar dados de empresas_filtradas para a tabela clientes do sistema
CORREÇÃO: Agora importa RAZAO_SOCIAL corretamente (do arquivo Empresas.csv)
"""
        ...
        while offset < total:
            ...
            cursor.execute(f"""
                SELECT 
                    CNPJ_COMPLETO,
                    CNPJ_BASICO,
                    RAZAO_SOCIAL,          -- ✅ CORRIGIDO: Agora busca RAZAO_SOCIAL!
                    NOME_FANTASIA,
                    MATRIZ_FILIAL,
                    SITUACAO_CADASTRAL,
                    ...
                    LATITUDE,
                    LONGITUDE,
                    PORTE_EMPRESA,         -- ✅ NOVO CAMPO
                    NATUREZA_JURIDICA      -- ✅ NOVO CAMPO
                FROM empresas_filtradas
                {where_clause}
                ORDER BY id
                LIMIT %s OFFSET %s
            ...
            for row in batch:
                try:
                    # ✅ CORRIGIDO: Agora extrai RAZAO_SOCIAL separadamente
                    (cnpj_completo, cnpj_basico, razao_social, nome_fantasia, matriz_filial, 
                     ...
                     fax, email, latitude, longitude, porte_empresa, natureza_juridica) = row
                    ...
                    # ✅ CORRIGIDO: Preparar dados para inserção
                    # name = Nome Fantasia (se existir) ou Razão Social
                    # razao_social = Razão Social oficial (do arquivo Empresas)
                    nome_exibicao = (nome_fantasia or razao_social or 'Sem nome')[:100]
                    razao_social_oficial = razao_social or nome_fantasia or 'Sem razão social'
                    ...
                    cursor.execute("""
                        INSERT INTO customers (
                            ...
                            porte_empresa, natureza_juridica,
                    ...
                    """, (
                        nome_exibicao,               # name = Nome Fantasia ou Razão Social
                        razao_social_oficial,        # ✅ razao_social = Razão Social OFICIAL
                        cnpj_completo, 
                        cnpj_basico,
                        email, 
                        telefone, 
                    ...
                    print(f"[DEBUG] CNPJ: {cnpj_completo}, Razão Social: {razao_social}, Nome Fantasia: {nome_fantasia}")
...
if __name__ == "__main__":
    print("\n" + "="*60)
    print("IMPORTAÇÃO CORRIGIDA - COM RAZÃO SOCIAL")
    print("="*60)
    print("\nEste script importa empresas_filtradas → customers")
    print("CORREÇÃO: Agora importa RAZAO_SOCIAL corretamente!\n")
