-- ========================================
-- DEPLOY FINAL - ORDEM DE PRODUÇÃO NA AWS
...
SELECT '📦 Criando tabelas...' as status;
...
-- Verificar trigger
SELECT 'TRIGGER:' as tipo, trigger_name as nome
FROM information_schema.TRIGGERS
WHERE trigger_schema = 'supply_chain_system'
AND trigger_name = 'gerar_numero_op';

SELECT '========================================' as '';
SELECT '✅ DEPLOY CONCLUÍDO COM SUCESSO!' as '';
SELECT 'Módulo Ordem de Produção pronto para uso!' as '';
SELECT '========================================' as '';
